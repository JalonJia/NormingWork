...
def upgrade_and_comple(s_ViewCode_home, s_VBCode_path, s_vbexe_path, s_compile_to) :
    ...
    smodule = 'EN'
    UpgradeVersionUtil.upgrade_view_projects(s_ViewCode_home, smodule, '67A', '66')
    #UpgradeVersionUtil.upgrade_vb_projects(s_VBCode_path, s_compile_to, smodule, '67A', True)
    UpgradeVersionUtil.upgrade_vb_projects_compatible(s_VBCode_path, '2')

    #os.chdir(s_vbexe_path)
    #VB6MakeFiles.comple_vb_projects_compatible(s_VBCode_path, s_vbexe_path, "0", "2", r'D:\Sage300\EN67A')



if __name__ == '__main__' :
    sToPath = r'D:\\Sage300\\' #必须使用两个反斜线，否则字符串中包含\S会报错
    s_vb_home = r'C:\Program Files (x86)\Microsoft Visual Studio\VB98'
    s_UI_home = r'D:\Pluswdev\EN67A\VBSource'
    s_View_home = r'D:\Pluswdev\EN67A\Source\Cprogram'
